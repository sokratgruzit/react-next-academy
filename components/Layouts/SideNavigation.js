      ...
      <ul className={styles.list}>
        {links?.map((item) => (
            <li className={styles.listItem} key={item._id}>
              <Link className={styles.item__inner} href={item.url}>
          ...
          <div className={styles.accordion}>
            <div className={styles.container}>
              <button
                ...
                className={styles.expand__item}
              >
                Topics
                <div
                  className={`${styles.toggle} ${topicsDropdown && styles.active}`}
                >
                  <span className={styles.item__svg}>
                    <svg
              ...
              >
                ...
                <div className={styles.listItem}>
                  <Link className={styles.item__inner} href='/articles'>
                    <span>See All</span>
                  </Link>
                </div>
              </div>
          ...
          <a className={styles.item}>
            <label className={styles.switcher}>
              ...
              <div className={styles.marker}>
                <div className={`${"lightLogo"} ${styles.lightLogo}`}>
                  <p>Light Mode</p>
                  <svg
                    width='24'
                    height='24'
                ...
                <div className={`${"darkLogo"} ${styles.darkLogo}`}>
