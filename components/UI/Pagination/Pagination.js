      ...
      <div style={customStyles}>
        <div className={styles.pagination}>
          <div className={styles.paginationInner}>
            <div className={`${styles.prev} ${paginationCurrent === 1 && styles.disabled}`} onClick={onPrevious}>
              <svg
                width="7"
                height="12"
                viewBox="0 0 7 12"
            ...
            {paginationRange.map((pageNumber, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`${pageNumber === paginationCurrent ? styles.activeElement : ''}`}
            ...
            <div className={`${styles.next} ${paginationCurrent === lastPage && styles.disabled}`} onClick={onNext}>
              <svg
                width="7"
                height="12"
                viewBox="0 0 7 12"
