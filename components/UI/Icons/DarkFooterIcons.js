import styles from "../../../styles/UI/FooterIcons/FooterIcons.module.scss";
  ...
  return (
    <div className={styles.socialLinks}>
      <a href="#" className={styles.link}>
        ...
        >
          <path
            d="M7.55016 20V10.8777H10.6109L11.0701 7.32156H7.55016V5.05147C7.55016 4.0222 7.83481 3.32076 9.31245 3.32076L11.194 3.31999V0.13923C10.8686 0.0969453 9.75167 0 8.45167 0C5.73708 0 3.87861 1.65697 3.87861 4.69927V7.32156H0.808594V10.8777H3.87861V20H7.55016Z"
            fill="#0500ff"
          />
        </svg>
        <svg
      ...
      <a href="#" className={styles.link}>
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_3645_3276)">
            <path
      ...
      <a href="#" className={styles.link}>
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_3645_3280)">
            <path
      ...
      <a href="#" className={styles.link}>
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_3645_3284)">
            <path
